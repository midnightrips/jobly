...
router.get("/", [ensureLoggedIn, ensureAdminOrCorrectUser], async function (req, res, next) {
  try {
...
router.get("/:username", ensureLoggedIn, async function (req, res, next) {
  try {
    ...
    if (
      ...
      throw new UnauthorizedError("Access forbidden: unauthorized");
    }
...
router.patch("/:username", ensureLoggedIn, async function (req, res, next) {
  try {
    ...
    const loggedInUser = res.locals.user;
    if (
      loggedInUser.username !== req.params.username &&
      !loggedInUser.isAdmin
    ) {
      throw new UnauthorizedError("Access forbidden: unauthorized");
    }
